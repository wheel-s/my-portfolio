  ...
  return (
    <div className=''>
        ...
        <section className= 'mt-18 p-4 hidden cursor-pointer bg-white-100  rounded-lg' id='nav'>
            ...
            <button className='bg-gray-700 text-gray-50 cursor-pointer rounded-md font-semibold p-[14px] hover:bg-gray-600 w-full '>Send a message</button>
        </section>
        ...
        <div className=' hidden md:flex justify-center mt-5 '>
           <div className=' fixed bg-[#ffffffe6] flex justify-around m-5 border-1 border-gray-400 p-[8px] w-[36rem] rounded-xl '>
            ...
            <NavLink to='https://github.com/wheel-s' target='blank'><hr className='w-2'/> <img src={github} alt={'nav...'} width={34} className='h-8 mr-2 mt-2' /> </NavLink>
             ...
             <button className='bg-gray-700 cursor-pointer rounded-lg px-3 py-[13px] w-40 hover:bg-gray-600 text-[1.1rem] font-bold ring-1 ring-gray-900 text-gray-50'>Send  message</button>
           </div> 
        </div>
    </div>
  )
